...
router.get("/", (req, res) => {
    ...
    res.json({
        ...
        ongoing: ['Acne Ongoing','Allergy Symptoms - Nose/Eyes','Asthma/COPD/Emphysema Ongoing','Body Aches','Cholesterol Visit','Diabetes','Erectile Dysfunction','Headaches &amp; Migraines','Hypertension (High Blood Pressure)','Insomnia','Nasal Congestion','acid or Skin Condition','Weight Loss Monitoring/Counselling'],
