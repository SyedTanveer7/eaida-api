...
router.get("/", (req, res) => {
    ...
    res.json({
        ...
        ongoing: ['Acid Reflux','Acne Ongoing','Allergy Symptoms - Nose/Eyes','Asthma/COPD/Emphysema Ongoing','Body Aches','Cholesterol Visit','Diabetes','Erectile Dysfunction','Headaches &amp; Migraines','Hypertension (High Blood Pressure)','Insomnia','Nasal Congestion','Rash or Skin Condition','Weight Loss Monitoring/Counselling'],
        skinIssue: ['Acne Ongoing','Acne Symptoms','Hives','Poison Ivy','Rash or Skin Condition','Shingles','Skin Issues','Toenail or Fingernail Infection'],
